          ...
          <div className="max-w-2xl mx-auto space-y-3 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {loading ? (
              Array.from({ length: 5 }).map((_, i) => (
                <div
                  key={i}
                  className="flex gap-4 p-4 items-center bg-card border rounded-2xl"
                >
              ...
              notifications.map((notification) => {
                ...
                if (notification.type === "follow") {
                  notificationPath = `/profile/${notification.actor_id}`;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 pr-8">
                      <p
                        className={`text-sm md:text-base mb-1 ${!notification.is_read ? "font-semibold text-foreground" : "text-muted-foreground"}`}
                      >
