...
console.log('For Vercel Environment Variables (Settings → Environment Variables):');
console.log('─'.repeat(70));
console.log(`VITE_VAPID_PUBLIC_KEY=${keys.publicKey}`);
...
console.log('4. Keep these keys secure - anyone with the private key can send notifications\n');
