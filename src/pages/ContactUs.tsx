    ...
    return (
        <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white p-4">
            ...
            <div className="grid lg:grid-cols-5 items-center p-2 [box-shadow:0_2px_10px_-3px_rgba(115,120,131,0.6)] rounded-lg mt-12">
                <div className="lg:col-span-2 bg-indigo-900 rounded-lg p-6 h-full max-lg:order-1 relative overflow-hidden max-lg:mt-12 min-h-[400px]">
                    <h3 className="text-[24px] text-white font-medium">Contact Us</h3>
                    <p className="text-[15px] text-slate-300 leading-relaxed mt-4">Have some thoughts about our website or need help with something? We'd love to hear from you.</p>
                    <div className="mt-16 relative z-50">
                        <ul className="space-y-8">
                            <li className="flex items-center text-slate-200 hover:text-white">
                                ...
                                <a href="mailto:info@example.com" className="text-[15px] ml-4">
                                    ...
                                </a>
                            </li>
                            <li className="flex items-center text-slate-200 hover:text-white">
                                ...
                                <a href="tel:+158996888" className="text-[15px] ml-4">
                                    +232
                                </a>
                            </li>
                            <li className="flex items-center text-slate-200 hover:text-white">
                    ...
                    <div className="absolute -bottom-24 -right-24 w-60 h-60 rounded-full bg-indigo-500/20"></div>
                </div>
                ...
                <div className="px-4 sm:px-8 py-4 lg:col-span-3">
                    <form onSubmit={handleSubmit}>
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    required
                                    className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-indigo-700 outline-none transition-colors"
                                />
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    className="px-2 py-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-indigo-600 outline-none transition-colors"
                                />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-4 h-4 absolute right-2"
                                    viewBox="0 0 24 24">
                                    <circle cx="10" cy="7" r="6" data-original="#000000"></circle>
                            ...
                            <div className="relative flex items-center col-span-full">
                                <textarea
                                    ...
                                    required
                                    className="px-2 pt-3 bg-white w-full text-sm text-slate-900 border-b border-gray-300 focus:border-indigo-600 outline-none transition-colors min-h-[100px]"
                                ></textarea>
                            </div>
                        ...
                        <button
                            ...
                            className="mt-12 flex items-center justify-center text-sm font-medium lg:ml-auto max-lg:w-full rounded-lg px-6 py-3 tracking-wide cursor-pointer text-white bg-indigo-700 hover:bg-indigo-800 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {isSubmitting ? (
                                <span>Sending...</span>
                            ) : (
