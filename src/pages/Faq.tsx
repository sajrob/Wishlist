 ...
 * Designed with a premium, clean aesthetic matching the main dashboard.
 */
...
function Faq() {
    const { user } = useAuth();
    const { categories, loading } = useWishlistContext();
    ...
    return (
        <SidebarProvider className="min-h-0 h-[calc(100vh-64px)]">
            <AppSidebar
                ...
                loading={loading}
            />
            <SidebarInset className="flex flex-col bg-slate-50/50 overflow-hidden border-l">
                {/* Sticky Header */}
