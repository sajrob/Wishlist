                    ...
                    <CardContent className="p-6 space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Use letters, numbers, and underscores only. This is
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <div className="bg-white/10 p-3 rounded-xl border border-white/20 flex flex-col items-center text-center">
                        ...
                        <div className="text-[9px] uppercase font-bold tracking-widest opacity-70">
                          Items
                        </div>
                      </div>
                      <div className="bg-white/10 p-3 rounded-xl border border-white/20 flex flex-col items-center text-center">
              ...
              <CardContent className="p-12 text-center space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground max-w-sm mx-auto">
                    Detailed analytics and activity history will be available
                    soon. Keep sharing your wishlist to see more insights!
                  </p>
                </div>
                <Button
                  variant="secondary"
