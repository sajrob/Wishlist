        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-xl text-center">
                <DialogHeader className="flex flex-col items-center">
                    <Gift className="bg-primary/10 p-2 rounded-lg text-primary size-10" />
                    <DialogTitle className="text-2xl font-bold">Welcome to <span className="text-primary">Me Lists</span>!</DialogTitle>
                </DialogHeader>
                <div className="space-y-8 ">
                    ...
                    <div className="space-y-4 text-left">
                        <div className="flex gap-4 items-start">
                            <div className="bg-primary/10 p-2 rounded-lg text-primary"><Gift size={20} /></div>
                            <div>
                        ...
                        <div className="flex gap-4 items-start">
                            <div className="bg-primary/10 p-2 rounded-lg text-primary"><Share2 size={20} /></div>
                            <div>
                        ...
                        <div className="flex gap-4 items-start">
                            <div className="bg-primary/10 p-2 rounded-lg text-primary"><Users size={20} /></div>
                            <div>
